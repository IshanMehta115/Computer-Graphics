...
private:
	...
	double texture_u; //texture coordinate u of the hit object
	double texture_v; //texture coordinate v of the hit object
...
public:  
	...
	bool setParameter(const float par, const Object *obj, Vector3D norm, const double u, const double v);
	bool didHit() const {return hit;}
	const Object* intersected() const {return object;}
	int getLevel() const {return level;}
	double get_object_texture_u() const {return texture_u;}
	double get_object_texture_v() const {return texture_v;}
