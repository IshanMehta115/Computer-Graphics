...
public:
	...
	void set_texture(const unsigned char* data);
	void set_texture_width(const int width);
	void set_texture_height(const int height);
	void set_texture_nrChannels(const int nr);
